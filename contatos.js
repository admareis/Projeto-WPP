...
//crie uma função que liste todos os usuários no console table
//crie uma função que receba o “indice” do usuário e retorne no console table todos os contatos dele
//crie uma função que receba o “indice” do usuário e retorne toddas as mensagens trocadas com este contato
...
export function receberIndice(idUser){
  console.table(usuarios["whats-users"][idUser].contacts);
}
//receberIndice();

export function listMsg(idUser,idMensagem){
  console.table(usuarios["whats-users"][idUser].contacts[idMensagem].messages);
}
